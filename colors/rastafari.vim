...
hi String       guifg=#cc3333 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkred
hi Constant     guifg=#cc3333 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkred
hi Special      guifg=#ff8800 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkyellow
hi Number       guifg=#cc3333 guibg=bg      gui=none term=none     cterm=none    ctermfg=darkred
...
hi TabLineFill  guifg=#80ff80 guibg=#008800 gui=bold term=bold     cterm=none    ctermfg=lightgreen ctermbg=darkgreen
hi TabLine      guifg=#80ff80 guibg=#008800 gui=bold term=standout cterm=bold    ctermfg=white      ctermbg=darkgreen
hi TabLineSel   guifg=#ffff60 guibg=#008800 gui=bold term=none     cterm=none    ctermfg=yellow     ctermbg=darkgreen
hi VertSplit    guifg=#80ff80 guibg=#008800 gui=none term=none     cterm=none    ctermfg=lightgreen ctermbg=darkgreen
...
hi DiffText     guifg=#3333ff guibg=#100090 gui=bold term=none cterm=none ctermfg=lightblue
...
hi diffChanged  guifg=#4040ff guibg=bg gui=none term=none cterm=none ctermfg=lightblue
...
hi vimCommentTitle guifg=#80ff80 guibg=bg      gui=bold term=none cterm=bold ctermfg=lightgreen
...
hi netrwExe     guifg=#cc3333 guibg=bg      gui=none term=none cterm=none ctermfg=darkred
...
hi confluenceHeadingMarker guifg=#cc3333 guibg=bg gui=none term=none cterm=none ctermfg=darkred
...
hi cppcheckError       guifg=#cc3333 guibg=bg gui=none term=none cterm=none ctermfg=darkred
